...
export const mockProjects: Project[] = [
  ...
  {
    id: '7',
    name: 'Mumbai Green Metro Transit',
    description: 'Modernizing public transportation with electric metro systems, reducing emissions from daily commutes for millions of residents.',
    category: 'infrastructure',
    pricePerCredit: 9.50,
    totalCredits: 600000,
    availableCredits: 520000,
    ...
    rating: 4.7,
    reviewCount: 112,
    seller: { id: 's7', name: 'GreenTransit India', verified: true },
    vintage: '2024',
    methodology: 'AM0031',
  ...
  {
    id: '8',
    name: 'Vietnam Community Biogas',
    description: 'Installing biogas digesters in rural communities to convert agricultural waste into clean cooking fuel, reducing deforestation and indoor pollution.',
    category: 'community',
    pricePerCredit: 7.25,
    totalCredits: 200000,
    availableCredits: 175000,
    location: 'Mekong Delta',
    country: 'Vietnam',
    isVerraCertified: true,
    sdgGoals: [1, 3, 7, 13],
    imageUrl: 'https://images.unsplash.com/photo-1569025690938-a00729c9e1f9?w=800&q=80',
    rating: 4.8,
    reviewCount: 94,
    seller: { id: 's8', name: 'Rural Energy Solutions', verified: true },
    vintage: '2023',
  ...
  {
    id: '9',
    name: 'Chilean Green Buildings',
    description: 'Retrofitting commercial buildings with energy-efficient systems including solar panels, smart HVAC, and LED lighting.',
    category: 'infrastructure',
    ...
    rating: 4.6,
    reviewCount: 67,
    seller: { id: 's9', name: 'EcoBuilders Chile', verified: true },
    vintage: '2024',
  ...
  {
    id: '10',
    name: 'Nepal Women Empowerment Initiative',
    description: 'Training women entrepreneurs in sustainable agriculture and clean energy technologies, creating livelihoods while reducing emissions.',
    category: 'community',
    pricePerCredit: 8.00,
    totalCredits: 180000,
    availableCredits: 165000,
    ...
    rating: 4.9,
    reviewCount: 143,
    seller: { id: 's10', name: 'Himalayan Green Fund', verified: true },
    vintage: '2024',
    methodology: 'VM0038',
  ...
  {
    id: '11',
    name: 'Morocco Solar Thermal Plant',
    description: 'Concentrated solar power plant providing clean electricity to 1.2 million households in North Africa.',
    category: 'renewable-energy',
    pricePerCredit: 13.50,
    totalCredits: 900000,
    availableCredits: 780000,
    location: 'Ouarzazate',
    country: 'Morocco',
    isVerraCertified: true,
    sdgGoals: [7, 9, 13, 17],
    ...
    rating: 4.8,
    reviewCount: 187,
    seller: { id: 's11', name: 'Sahara Solar Energy', verified: true },
    vintage: '2023',
    methodology: 'ACM0002',
  ...
  {
    id: '12',
    name: 'Philippines Coral Reef Restoration',
    description: 'Rebuilding degraded coral reef ecosystems to enhance marine biodiversity and carbon sequestration in coastal waters.',
    category: 'ocean',
    ...
    rating: 4.7,
    reviewCount: 56,
    seller: { id: 's12', name: 'Ocean Guardians Asia', verified: true },
    vintage: '2024',
    methodology: 'VM0033',
